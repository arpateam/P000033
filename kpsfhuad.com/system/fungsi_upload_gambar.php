...
function uploadGambarSlider($name_file, $type_file, $location_file, $location_upload){
...
function uploadFotoWithSmall($name_file, $type_file, $location_file, $location_upload, $location_upload_small){
