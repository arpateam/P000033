    ...
    <div class="row justify-content-center">
        <div class="col-11 col-lg-8 col-xl-6 bg-success shadow rounded text-center py-3">
            <span class="d-none d-lg-block">
                ...
                <a href="#" title="" class="nav-link-danger active">Pengumuman</a>
            </span>
...
<div class="container my-5">
    <div class="row justify-content-between">
        <div class="col-12">
            <h1 class="text-success">PENGUMUMAN <?= $namaweb ?></h1>
        ...
        <div class="col-12 mt-2">
            <div class="row">
                <?php
                    ...
                    $page   = new pagingPengumuman;
                    $batas  = 9;
                    $posisi = $page->cariPosisi($batas);

                    $Data   = $pdo->query("SELECT id_pengumuman, judul, gambar, deskripsi, seo, tgl_update FROM pengumuman ORDER BY tgl_update DESC LIMIT $posisi,$batas");
                    $Data2  = $pdo->query("SELECT id_pengumuman, judul, gambar, deskripsi, seo, tgl_update FROM pengumuman ORDER BY tgl_update DESC");
                ...
                <div class="col-sm-6 col-lg-4 my-3">
                    <div class="card h-100 bg-light border-0 shadow">
                        <img src="../assets/images/pengumuman/small/<?= $resultData['gambar'] ?>" class="card-img" alt="<?= $resultData['judul'] ?>">
