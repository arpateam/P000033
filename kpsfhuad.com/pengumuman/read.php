<?php
    ...
    $Detail = $pdo->query("SELECT judul, deskripsi, gambar, dikunjungi, tgl_update FROM pengumuman WHERE seo='$_GET[judul_seo]'");
    ...
    $sql2 = "UPDATE pengumuman SET dikunjungi = :dikunjungi WHERE seo = :seo";
    ...
    <div class="row justify-content-center">
        <div class="col-11 col-lg-9 col-xl-8 bg-success shadow rounded text-center py-3">
            <span class="d-none d-lg-block">
                ...
                <a href="../pengumuman/" title="" class="nav-link-danger">Pengumuman</a>
                <i class="fas fa-angle-right text-danger"></i>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    <div class="card-title mb-0 text-center">
                        <img src="../assets/images/pengumuman/<?= $resultDetail['gambar'] ?>" alt="Gambar <?= $resultDetail['judul'] ?>" class="img-thumbnail mb-1">
