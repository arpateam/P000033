<?php
    ...
    $hal                = "Pengumuman";
    $penyimpananGambar  = "../assets/images/pengumuman/small";
    $database           = "pengumuman";
    $link               = "pengumuman";
    ...
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="page-header">
                <h4 class="page-title text-light d-none d-md-block"><i class="fas fa-bullhorn"></i> <?= $hal; ?></h4>
                            ...
                            <table id="tabelData" class="table table-striped table-bordered py-2" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" width="300px">Judul <?= $hal ?></th>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $Data = $pdo->query("SELECT * FROM $database ORDER BY tgl_update DESC");
                                        while($resultData = $Data->fetch(PDO::FETCH_ASSOC)){
                                    ?>

                                    <tr>
                                        <td>
                                            <a target="_blank" href="<?= $link1; ?>/<?= $link ?>/<?= $resultData['seo']; ?>.html" role="button" class="btn btn-sm btn-success">
                                                <i class="fas fa-external-link-alt"></i>
                                            </a>
                                            <a href="ubah-<?= $link ?>-<?= $resultData['id_pengumuman']; ?>">
                                                <button type="button" class="btn btn-sm btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </a>
                                            <a onclick="confirmHapusPengumuman('<?= $resultData['id_pengumuman']; ?>')" class="btn btn-sm btn-danger text-light"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                        <td><?= $resultData['judul']; ?></td>
                                        <td><img src="<?= $penyimpananGambar ?>/<?= $resultData['gambar']; ?>" alt="<?= $resultData['gambar']; ?>" class="img-thumbnail my-2"></td>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionTambahPengumuman" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
                                ...
                                <!-- Data Utama -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group-default">
                                            <label class="font-weight-bold">Judul <?= $hal ?></label>
                                            ...
                                            <div class="invalid-feedback fw-bold">
                                                <i class="fas fa-exclamation-triangle"></i> Mohon Masukkan Judul <?= $hal ?>!
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <!-- Gambar -->
                                    <div class="col-12 mt-4">
                                        <div class="alert alert-primary shadow-sm pb-2" role="alert">
                                            <h4 class="fw-bold text-primary"><i class="fas fa-image"></i> Gambar <?= $hal ?></h4>
                                        </div>
                                    </div>
...
<?php
        ...
        $Data       = $pdo->query("SELECT id_pengumuman, judul, gambar, deskripsi, keyword, description, id_sitemap_1 FROM $database WHERE id_pengumuman='$_GET[kode]'");
    ...
    <div class="page-inner mt--5">
        <div class="row justify-content-center mt--5">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionEditPengumuman" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
                                ...
                                <!-- Data Utama -->
                                    ...
                                    <div class="col-12">
                                        <div class="form-group-default">
                                            <label class="font-weight-bold">Judul <?= $hal ?></label>
                                            <input id="judul" name="___in_judul_special_KPSFHUAD" type="text" class="form-control input-border-bottom" placeholder="Cth: Joko Widodo Terpilih Sebagai Presiden Indonesia Periode 2019-2024" value="<?= $resultData['judul']; ?>" required>
                                            <div class="invalid-feedback fw-bold">
                                                <i class="fas fa-exclamation-triangle"></i> Mohon Masukkan Judul <?= $hal ?>!
                                            </div>
                                        </div>
                                ...
                                <!-- Deskripsi -->
                                    <div class="col-12 mt-4 mb-2">
                                        <div class="alert alert-primary shadow-sm pb-2" role="alert">
                                            <h4 class="fw-bold text-primary"><i class="fas fa-newspaper"></i> Deskripsi <?= $hal ?></h4>
                                        </div>
                                    </div>
                                ...
                                <!-- Gambar -->
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="file-upload-content-edit text-center">
                                            ...
                                            <img class="file-upload-image px-2 pt-2 px-md-4" src="../assets/images/<?= $link ?>/<?= $resultData['gambar']; ?>" alt="<?= $resultData['judul']; ?>" />
                                ...
                                <div class="col-12 my-4">
                                    <input type="hidden" name="___in_id_pengumuman_special_KPSFHUAD" value="<?= $resultData['id_pengumuman']; ?>">
