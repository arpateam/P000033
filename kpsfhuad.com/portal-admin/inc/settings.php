...
<div class="content">
	<div class="page-inner">
		<div class="page-header">
			<h4 class="page-title text-primary d-none d-md-block"><i class="fas fa-video"></i> Video Beranda</h4>
			<ul class="breadcrumbs">
				<li class="nav-home">
					<a href="dashboard">
						<i class="flaticon-home"></i>
				...
				<li class="nav-item">
					<a href="#"><u>Edit Video Beranda</u></a>
				</li>
			</ul>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<div class="card-title">Form Edit Video Beranda</div>
	                	...
	                	<ul class="nav nav-tabs" id="myTab" role="tablist">
						  	<li class="nav-item">
						    	<a class="nav-link active">
						    		<h4 class="font-weight-bold"><i class="fas fa-video"></i> Video Beranda</h4>
						    	</a>
						  	</li>
						 	<li class="nav-item">
						    	<a class="nav-link" href="ubah-video-beranda" role="tab">
						    		<h4 class="font-weight-bold"><i class="fas fa-edit"></i> Ubah Video</h4>
						    	</a>
						  	</li>
						</ul>
						  	...
						  	<div class="tab-pane fade show active">
							  	<div class="mb-4 p-3 border-left border-bottom border-right text-center">
								    <video class="img-fluid" controls autoplay>
									  	<source src="../assets/parallax-video/<?= $resultEdit['deskripsi'] ?>" type="video/mp4">
									  	<span class="text-danger">Your browser does not support the video tag.</span>
									</video>
								</div>
						  	</div>
						</div>
			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
	                	<ul class="nav nav-tabs" id="myTab" role="tablist">
						  	<li class="nav-item">
						    	<a class="nav-link" href="video-beranda">
						    		<h4 class="font-weight-bold"><i class="fas fa-video"></i> Video Beranda</h4>
						    	</a>
						  	</li>
						 	<li class="nav-item">
						  	...
						  	<div class="tab-pane fade show active" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
							  	...
							  	<form id="upload_form" class="needs-validation" novalidate>
							  		...
							  		<div class="alert alert-warning my-2 pb-1 text-warning" role="alert">
									  	<ul>
									  		<li><i class="fas fa-exclamation-triangle"></i> Video yang anda upload harus <strong>.mp4</strong></li>
									  		<li><i class="fas fa-exclamation-triangle"></i> <strong>Ukuran Video</strong> tidak boleh lebih dari <strong>10MB</strong></li>
									  	</ul>
									</div>

									<div class="form-group mt-2">
										<label id="pilihFileVideo">Pilih File Video</label><br/>
										<input type="file" name="file" id="file" for="pilihFileVideo" class="form-control" accept="video/mp4" required>
									</div>
					                ...
					                <div class="mt-2 pt-4 border-top">
					                    <input type="button" id="upload" value="UPLOAD VIDEO" class="btn btn-lg btn-block btn-primary">
					                </div>
					                <!--end footer button-->
							  	</form>
							</div>
