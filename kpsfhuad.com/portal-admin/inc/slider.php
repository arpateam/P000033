<?php
    ...
    $hal                = "Daftar Slider";
    $penyimpananGambar  = "../assets/images/slider";
    $database           = "slider";
    $link               = "slider";
                            ...
                            <table id="tabelData" class="table table-striped table-bordered py-2" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" width="200px">Nama Slider</th>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $Data = $pdo->query("SELECT id_slider, urutan, nama_slider, gambar, status FROM $database ORDER BY urutan ASC");
                                        while($resultData = $Data->fetch(PDO::FETCH_ASSOC)){
                                    ?>

                                    <tr>
                                        <td>
                                            <a href="ubah-<?= $link ?>-<?= $resultData['id_slider']; ?>">
                                                <button type="button" class="btn btn-sm btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </a>
                                            <a onclick="confirmHapusSlider('<?= $resultData['id_slider']; ?>')" class="btn btn-sm btn-danger text-light"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                        <td>
                                        ...
                                        <td><h2 class="badge badge-info"><?= rp($resultData['urutan']); ?></h2></td>
                                        <td><h5><ins><?= $resultData['nama_slider']; ?></ins></h5></td>
                                        <td>
                                            <img src="<?= $penyimpananGambar.'/'.$resultData['gambar'] ?>" alt="Gambar Slider <?= $resultData['nama_slider']; ?>" class="img-thumbnail">
                                        </td>
                                    </tr>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionTambahSlider" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
                                ...
                                <!-- Data Utama -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group-default">
                                            <label class="font-weight-bold">Urutan Slider</label>
                                            <div class="input-group">
                                                ...
                                                <div class="invalid-feedback fw-bold">
                                                    <i class="fas fa-exclamation-triangle"></i> Mohon Masukkan Urutan Slider!
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group-default">
                                            ...
                                            <input id="nama_slider" name="___in_nama_slider_special_KPSFHUAD" type="text" class="form-control input-border-bottom" placeholder="Cth: Kegiatan Rapat Periode 2021-2022" required>
                                            <div class="invalid-feedback fw-bold">
                                                <i class="fas fa-exclamation-triangle"></i> Mohon Masukkan Nama Slider!
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group-default">
                                            <label class="font-weight-bold">Status Slider</label>
                                            ...
                                            <div class="invalid-feedback fw-bold">
                                                <i class="fas fa-exclamation-triangle"></i> Mohon Pilih Status Slider!
                                            </div>
                                        </div>
                                    </div>
...
<?php
        ...
        $Data       = $pdo->query("SELECT * FROM $database WHERE id_slider='$_GET[kode]'");
        ...
        <div class="page-inner py-5">
            <div class="page-header">
                ...
                <ul class="breadcrumbs text-light">
                    ...
                    <li class="nav-item">
                        <a href="#" class="text-light disable">Mengubah <?= $hal; ?> <u>"<?= $resultData['nama_slider'] ?>"</u></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="page-inner mt--5">
        <div class="row justify-content-center mt--5">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionEditSlider" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
                                ...
                                <!-- Data Utama -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group-default">
                                            <label class="font-weight-bold">Nama Slider</label>
                                            <input id="nama_slider" name="___in_nama_slider_special_KPSFHUAD" type="text" class="form-control input-border-bottom" placeholder="Cth: Kegiatan Rapat Periode 2021-2022" value="<?= $resultData['nama_slider']; ?>" required>
                                            <div class="invalid-feedback fw-bold">
                                                <i class="fas fa-exclamation-triangle"></i> Mohon Masukkan Nama Slider!
                                            </div>
                                        </div>
                                ...
                                <!-- Gambar Slider -->
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="file-upload-content">
                                            ...
                                            <img class="file-upload-image px-2 pt-2 px-md-4" src="#" alt="<?= $resultData['nama_slider']; ?>" />
                                        ...
                                        <div class="file-upload-content-edit text-center">
                                            ...
                                            <img class="file-upload-image px-2 pt-2 px-md-4" src="../assets/images/<?= $link ?>/<?= $resultData['gambar']; ?>" alt="<?= $resultData['nama_slider']; ?>" />
                                        ...
                                        <div class="invalid-feedback fw-bold">
                                            Mohon pilih gambar untuk Slider anda
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 my-4">
                                    <input type="hidden" name="___in_id_slider_special_KPSFHUAD" value="<?= $resultData['id_slider']; ?>">
