    ...
    <section class="container bg-primary my-2 my-md-5">
        <div class="row justify-content-center">
            ...
            <div class="col-10 col-xs-8 col-md-6 col-lg-5 col-xl-5 p-4 text-center">
                <h1 class="text-light">Selamat Datang di <strong>Portal</strong>Admin <br /><strong><?= $namaweb; ?></strong></h1>
                <hr />
                <a href="<?= $linkWeb1; ?>">
                    <img src="../assets/images/<?= $logoVersiDesktop; ?>" alt="<?= $judulLogoVersiDesktop; ?>" style="width: 55%">
                </a>
            </div>
                ...
                <form method="POST" action="actionLogin" class="text-left text-primary needs-validation" novalidate>
                    ...
                    <div class="form-group form-group-default">
                        <div class="input-group">
                            <div class="g-recaptcha" data-sitekey="6Lfc-rEUAAAAABsNHZg_fNWRJgdG50edntZlyo_t" required></div>
                        </div>
                    </div>
