<?php
    ...
    $hal                = "Berita";
    $penyimpananGambar  = "../assets/images/berita/small";
    $database           = "berita";
    $link               = "berita";
    ...
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="page-header">
                <h4 class="page-title text-light d-none d-md-block"><i class="fas fa-newspaper"></i> <?= $hal; ?></h4>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="ubah-<?= $link ?>-<?= $resultData['id_berita']; ?>">
                                                <button type="button" class="btn btn-sm btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </a>
                                            <a onclick="confirmHapusBerita('<?= $resultData['id_berita']; ?>')" class="btn btn-sm btn-danger text-light"><i class="fas fa-trash-alt"></i></a>
                                        </td>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionTambahBerita" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
...
<?php
        ...
        $Data       = $pdo->query("SELECT id_berita, judul, gambar, deskripsi, keyword, description, id_sitemap_1 FROM $database WHERE id_berita='$_GET[kode]'");
    ...
    <div class="page-inner mt--5">
        <div class="row justify-content-center mt--5">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionEditBerita" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col-12 my-4">
                                    <input type="hidden" name="___in_id_berita_special_KPSFHUAD" value="<?= $resultData['id_berita']; ?>">
