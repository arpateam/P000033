...
if (empty($_SESSION['_kode_login__'])) {
    ...
    // Data file
    $link                   = "pengumuman";
    $penyimpananGambar      = "../../assets/images/pengumuman";
    $penyimpananGambarSmall = "../../assets/images/pengumuman/small";
    $database               = "pengumuman";
    $act                    = $_GET["act"];
    // Data file
    ...
    if ($_GET['act']==="01") {
        ...
        // SiteMap 1
            ...
            $id_sub_sitemap     = 10;
            $loc_1              = $link1."/pengumuman/".$seo.".html";
            $priority_1         = "0.80";
        // SiteMap 1
    ...
    elseif ($_GET['act']==="02") {
        ...
        $id_pengumuman    = htmlspecialchars($_POST['___in_id_pengumuman_special_KPSFHUAD']);
        $judul          = htmlspecialchars($_POST['___in_judul_special_KPSFHUAD']);
        $seo            = seo($judul)."-".rand(00,99);
        ...
        try {
            $sql = "UPDATE $database
                    ...
                    WHERE id_$database  = :id_pengumuman
                ";
                          
            $statement = $pdo->prepare($sql);

            $statement->bindParam(":id_pengumuman", $id_pengumuman, PDO::PARAM_INT);
            ...
            if ($count>0) {
                $_SESSION['_msg__']  = "Berhasil";
                echo "<script>window.location = 'ubah-$link-$id_pengumuman'</script>";
                die();
                exit();
            }
        }catch(PDOException $e){
