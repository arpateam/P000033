<?php
    ...
    $hal                = "Prestasi";
    $penyimpananGambar  = "../assets/images/prestasi/small";
    $database           = "prestasi";
    $link               = "prestasi";
    ...
    <div class="panel-header bg-primary-gradient pb-5">
        <div class="page-inner py-5">
            <div class="page-header">
                <h4 class="page-title text-light d-none d-md-block"><i class="fas fa-trophy"></i> <?= $hal; ?></h4>
                        ...
                        <div class="table-responsive">
                            <table id="tabelData" class="table table-striped table-bordered py-2" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a target="_blank" href="<?= $link1; ?>/<?= $link ?>/<?= $resultData['judul_seo']; ?>.html" role="button" class="btn btn-sm btn-success">
                                                <i class="fas fa-external-link-alt"></i>
                                            </a>
                                            <a href="ubah-<?= $link ?>-<?= $resultData['id_prestasi']; ?>">
                                                <button type="button" class="btn btn-sm btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </a>
                                            <a onclick="confirmHapusPrestasi('<?= $resultData['id_prestasi']; ?>')" class="btn btn-sm btn-danger text-light"><i class="fas fa-trash-alt"></i></a>
                                        </td>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionTambahPrestasi" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
...
<?php
        ...
        $Data       = $pdo->query("SELECT id_prestasi, judul, gambar, deskripsi, keyword, description, id_sitemap_1 FROM $database WHERE id_prestasi='$_GET[kode]'");
    ...
    <div class="page-inner mt--5">
        <div class="row justify-content-center mt--5">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body tab-content pb-0" id="pills-without-border-tabContent">
                        <form method="POST" action="actionEditPrestasi" enctype="multipart/form-data" class="text-left needs-validation" novalidate>
                            <div class="row">
                                ...
                                <div class="col-12 my-4">
                                    <input type="hidden" name="___in_id_prestasi_special_KPSFHUAD" value="<?= $resultData['id_prestasi']; ?>">
