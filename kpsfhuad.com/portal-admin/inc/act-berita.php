...
if (empty($_SESSION['_kode_login__'])) {
    ...
    // Data file
    $link                   = "berita";
    $penyimpananGambar      = "../../assets/images/berita";
    $penyimpananGambarSmall = "../../assets/images/berita/small";
    $database               = "berita";
    $act                    = $_GET["act"];
    // Data file
    ...
    elseif ($_GET['act']==="02") {
        ...
        $id_berita    = htmlspecialchars($_POST['___in_id_berita_special_KPSFHUAD']);
        $judul          = htmlspecialchars($_POST['___in_judul_special_KPSFHUAD']);
        $seo            = seo($judul)."-".rand(00,99);
        ...
        try {
            ...
            if ($count>0) {
                $_SESSION['_msg__']  = "Berhasil";
                echo "<script>window.location = 'ubah-$link-$id_berita'</script>";
                die();
                exit();
            }
        }catch(PDOException $e){
