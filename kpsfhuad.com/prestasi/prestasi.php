    ...
    <div class="row justify-content-center">
        <div class="col-11 col-lg-8 col-xl-6 bg-success shadow rounded text-center py-3">
            <span class="d-none d-lg-block">
                ...
                <a href="#" title="" class="nav-link-danger active">Prestasi</a>
            </span>
...
<div class="container my-5">
    <div class="row justify-content-between">
        <div class="col-12">
            <h1 class="text-success">PRESTASI <?= $namaweb ?></h1>
            <h6 class="text-danger">Kami selama ini telah memiliki beberapa Pestasi</h6>
        </div>
        <div class="col-6">
        ...
        <div class="col-12 mt-2">
            <div class="row">
                <?php
                    ...
                    $page   = new pagingPrestasi;
                    $batas  = 9;
                    $posisi = $page->cariPosisi($batas);

                    $Data   = $pdo->query("SELECT id_prestasi, judul, gambar, deskripsi, seo, tgl_update FROM prestasi ORDER BY tgl_update DESC LIMIT $posisi,$batas");
                    $Data2  = $pdo->query("SELECT id_prestasi, judul, gambar, deskripsi, seo, tgl_update FROM prestasi ORDER BY tgl_update DESC");
                ...
                <div class="col-sm-6 col-lg-4 my-3">
                    <div class="card h-100 bg-light border-0 shadow">
                        <img src="../assets/images/prestasi/small/<?= $resultData['gambar'] ?>" class="card-img" alt="<?= $resultData['judul'] ?>">
