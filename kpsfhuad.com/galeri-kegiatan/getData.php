<?php
    ...
    // selecting posts
    $Data       = $pdo->query("SELECT id_galeri_kegiatan, sub_galeri_kegiatan, judul, foto, keterangan, link_youtube, seo, tgl_update FROM galeri_kegiatan ORDER BY tgl_update DESC LIMIT $row,$rowperpage");
