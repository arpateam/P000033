    ...
    <div class="row justify-content-center">
        <div class="col-11 col-lg-8 col-xl-6 bg-success shadow rounded text-center py-3">
            <span class="d-none d-lg-block">
                ...
                <a href="#" title="" class="nav-link-danger active">Semua Galeri Kegiatan</a>
            </span>
            <small class="d-block d-lg-none">
                <a href="/" title="Beranda" class="nav-link-danger"><i class="fas fa-home"></i> Beranda</a>
                <i class="fas fa-angle-right text-danger"></i>
                <a href="#" title="" class="nav-link-danger active">Galeri Kegiatan</a>
            </small>
        </div>
    </div>
</div>
...
<div class="container my-5">
    <div class="row justify-content-between">
        <div class="col-12">
            <h1 class="text-success">SEMUA GALERI KEGIATAN</h1>
            <h6 class="text-danger">Hay, yuk simak Semua Galeri Kegiatan kami</h6>
        </div>
        <div class="col-6">
        ...
        <div class="col-12 mt-5 text-center">
            <div class="btn-group">
                <a href="#" class="btn btn-danger" aria-current="page">SEMUA</a>
                <a href="nmcc.html" class="btn btn-success">NMCC</a>
        ...
        <div class="col-12 mt-3">
            ...
            <div class="row justify-content-center">
                <?php
                    ...
                    $AllData            = $pdo->query("SELECT count(*) as allcount FROM galeri_kegiatan");
                    $resultAllData      = $AllData->fetch(PDO::FETCH_ASSOC);
                    $allcount           = $resultAllData['allcount'];

                    // select first 3 posts
                    $Data               = $pdo->query("SELECT id_galeri_kegiatan, sub_galeri_kegiatan, judul, foto, keterangan, link_youtube, seo, tgl_update FROM galeri_kegiatan ORDER BY tgl_update DESC LIMIT 0,$rowperpage");
