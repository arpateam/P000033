    ...
    <div class="row justify-content-center">
        <div class="col-11 col-lg-8 col-xl-6 bg-success shadow rounded text-center py-3">
            <span class="d-none d-lg-block">
                ...
                <a href="#" title="" class="nav-link-danger active">Galeri Kegiatan PROKER</a>
            </span>
...
<div class="container my-5">
    <div class="row justify-content-between">
        <div class="col-12">
            <h1 class="text-success">GALERI KEGIATAN PROKER</h1>
            <h6 class="text-danger">Hay, yuk simak Galeri Kegiatan PROKER kami</h6>
        </div>
        <div class="col-6">
        ...
        <div class="col-12 mt-5 text-center">
            <div class="btn-group">
                ...
                <a href="#" class="btn btn-danger">PROKER</a>
            </div>
        </div>
        <div class="col-12 mt-3">
            <div class="row justify-content-center">
                <?php
                    ...
                    $AllData            = $pdo->query("SELECT count(*) as allcount FROM galeri_kegiatan WHERE sub_galeri_kegiatan='PROKER'");
                    $resultAllData      = $AllData->fetch(PDO::FETCH_ASSOC);
                    $allcount           = $resultAllData['allcount'];

                    // select first 3 posts
                    $Data               = $pdo->query("SELECT id_galeri_kegiatan, sub_galeri_kegiatan, judul, foto, keterangan, link_youtube, seo, tgl_update FROM galeri_kegiatan WHERE sub_galeri_kegiatan='PROKER' ORDER BY tgl_update DESC LIMIT 0,$rowperpage");
